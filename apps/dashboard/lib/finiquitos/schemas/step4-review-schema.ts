...
export const updateFiniquitoSchema = z.object({
  ...
  pendingVacationDays: z.coerce.number().optional(),
  pendingVacationPremium: z.coerce.number().optional(),
  ...
  complementPendingVacationDays: z.coerce.number().optional(),
  complementPendingVacationPremium: z.coerce.number().optional(),
